...
const Assets = zod_1.z
    ...
    firstPageBackground: zod_1.z.string().url().optional(),
    otherPagesBackground: zod_1.z.string().url().optional(),
})
    .partial()
    .default({});
...
const ImageGridComp = CompBase.extend({
    ...
    props: zod_1.z
        .object({
        title: zod_1.z.string().optional(),
        rows: zod_1.z.array(zod_1.z.array(zod_1.z.string().url())).min(1),
    })
        .strict(),
});
/* ---------- Discriminated union ---------- */
...
exports.ReportSchema = zod_1.z
    ...
    assets: zod_1.z.object({
        ...
        firstPageBackground: imageRef.nullish(),
        otherPagesBackground: imageRef.nullish(),
    }),
