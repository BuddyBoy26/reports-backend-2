...
const toDataUri_js_1 = require("./lib/toDataUri.js");
...
async function hydrateAssets(report) {
    ...
    report.assets.firstPageBackground = (await (0, toDataUri_js_1.toDataUri)(report.assets.firstPageBackground)) ?? report.assets.firstPageBackground;
    report.assets.otherPagesBackground = (await (0, toDataUri_js_1.toDataUri)(report.assets.otherPagesBackground)) ?? report.assets.otherPagesBackground;
