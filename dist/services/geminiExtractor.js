...
class GeminiExtractor {
    ...
    async extractBillOfEntryData(pdfText, customLabels = {}) {
    ...
    async extractSelectiveFields(pdfText, fieldsToExtract, documentType) {
    ...
    createDynamicExtractionPrompt(customLabels) {
...
Search thoroughly through the entire document for each field.`;
    ...
    createSelectiveExtractionPrompt(fieldsToExtract, documentType) {
